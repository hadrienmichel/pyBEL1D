...
if __name__ == '__main__':
    ...
    if RunFigs:
        ...
        # MCMC_Models, _ = PrebelInit.runMCMC(Dataset=NoisyDatasetBenchmark, NoiseModel=np.ones(DatasetBenchmark.shape)*Noise, nbSamples=1000000, nbChains=20, noData=True, verbose=True)
        # np.save('MRS2021Figs/MCMC_MRS2021_Benchmark_1000000M_10hCPU.npy',MCMC_Models)
        # MCMC_Models = np.load('MRS2021Figs/MCMC_MRS2021_Benchmark_100000M_1hCPU.npy')
        # MCMC = []
