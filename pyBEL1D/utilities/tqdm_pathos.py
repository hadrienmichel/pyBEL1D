...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 28 15:36:45 2022

Progress bars for multiprocessing with pathos
Wrappers based on parmap for multiprocessing with pathos and progress bar 
completion with tqdm. Following parmap, multiprocessing is extended to 
functions of multiple iterables, arguments, and keyword arguments.
While parmap includes these extensions and a progress bar, it is built on the 
default multiprocessing library. The multiprocessing/pools module in pathos 
includes enhanced serialization to allow multiprocessing of, e.g., lambda 
functions, class methods, etc.

https://github.com/mdmould/tqdm_pathos/blob/main/tqdm_pathos/tqdm_pathos.py
