...
import matplotlib.pyplot as plt             # For matlab-like graphs
...
class PREBEL:
    ...
    def ShowPriorDataset(self, c_map:str='tab20c', loglog=False, abs_mark_sub0=False):
        ...
        It takes as arguments:
            ...
            - loglog: (boolean, False) log scaling both axes
            - abs_mark_sub0: (boolean, False) mark negative data values with squares
